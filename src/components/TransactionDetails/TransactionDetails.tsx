...
const TransactionDetails: React.FC<Props> = ({ transaction, className }) => {
  return (
    <dl className={classNames('border-b border-licorice-500', className)}>
      <div className="flex items-center border-t border-licorice-500 py-1.5">
        <dt className="w-48 text-xs font-normal text-licorice-100">Source</dt>
      ...
      <div className="flex items-center border-t border-licorice-500 py-1.5">
        <dt className="w-48 text-xs font-normal text-licorice-100">
          Destination
        </dt>
        <dd className="text-sm font-bold">
      ...
      <div className="flex items-center border-t border-licorice-500 py-1.5">
        ...
        <dd className="text-sm font-bold">{transaction?.address}</dd>
      </div>

      <div className="flex items-center border-t border-licorice-500 py-1.5">
        <dt className="w-48 text-xs font-normal text-licorice-100">Amount</dt>
        <dd className="text-sm font-bold">
